...
})({"7vIXm":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cce5b2ea81e41450";
"use strict";
...
},{}],"due8H":[function(require,module,exports) {
var _contentfulUiExtensionsSdk = require("contentful-ui-extensions-sdk");
var _deepCopy2 = require("./deep-copy2");
let space = null;
let entry = null;
let extension = null;
let state = "idle";
...
(0, _contentfulUiExtensionsSdk.init)((getExtension)=>{
...
},{"contentful-ui-extensions-sdk":"62bvF","./deep-copy2":"8Fle5"}],"62bvF":[function(require,module,exports) {
parcelRequire = function(e, r, n, t) {
    var i = "function" == typeof parcelRequire && parcelRequire, o = undefined;
    function u(n, t) {
        if (!r[n]) {
            if (!e[n]) {
    ...
    "Zt7E": [
        function(require, module1, exports) {
            ...
            var t, e = arguments[3], r = require("process");
            !function(e, r) {
                "object" == typeof exports && "undefined" != typeof module1 ? module1.exports = r() : "function" == typeof t && t.amd ? t(r) : e.ES6Promise = r();
            }(this, function() {
                "use strict";
                function t(t) {
                ...
                }, o = 0, i = void 0, s = void 0, u = function(t, e) {
                    p[o] = t, p[o + 1] = e, 2 === (o += 2) && (s ? s(_) : w());
                };
                var c = "undefined" != typeof window ? window : void 0, a = c || {}, f = a.MutationObserver || a.WebKitMutationObserver, l = "undefined" == typeof self && void 0 !== r && "[object process]" === ({}).toString.call(r), h = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel;
                function v() {
                    var t = setTimeout;
                    return function() {
                        return t(_, 1);
                ...
                var p = new Array(1e3);
                function _() {
                    for(var t = 0; t < o; t += 2)(0, p[t])(p[t + 1]), p[t] = void 0, p[t + 1] = void 0;
                    o = 0;
                }
                var d, y, m, b, w = void 0;
                function g(t, e) {
                ...
                l ? w = function() {
                    ...
                    b.data = y = ++y % 2;
                }) : h ? ((d = new MessageChannel).port1.onmessage = _, w = function() {
                ...
                function C(e, r, n) {
                    r.constructor === e.constructor && n === g && r.constructor.resolve === A ? function(t, e) {
                        e._state === T ? F(t, e._result) : e._state === M ? Y(t, e._result) : k(e, void 0, function(e) {
                            return O(t, e);
                        }, function(e) {
                            return Y(t, e);
                        });
                    }(e, r) : n === P ? (Y(e, P.error), P.error = null) : void 0 === n ? F(e, r) : t(n) ? function(t, e, r) {
                        u(function(t) {
                ...
                function O(t, e) {
                    var r, n;
                    t === e ? Y(t, new TypeError("You cannot resolve a promise with itself")) : (n = typeof (r = e), null === r || "object" !== n && "function" !== n ? F(t, e) : C(t, e, x(e)));
                }
                function q(t) {
                ...
                function D(t) {
                    ...
                    if (0 !== e.length) {
                        for(var n = void 0, o = void 0, i = t._result, s = 0; s < e.length; s += 3)n = e[s], o = e[s + r], n ? K(r, n, o, i) : o(i);
                ...
                function K(e, r, n, o) {
                    ...
                    if (i) {
                        ...
                        }(n, o)) === P ? (a = !0, u = s.error, s.error = null) : c = !0, r === s) return void Y(r, new TypeError("A promises callback cannot return that same promise."));
                    } else s = o, c = !0;
                    r._state !== E || (i && c ? O(r, s) : a ? Y(r, u) : e === T ? F(r, s) : e === M && Y(r, s));
                }
                var L = 0;
                function N(t) {
                ...
                var U = function() {
                    ...
                    return t.prototype._enumerate = function(t) {
                        ...
                        var n = this.promise;
                        n._state === E && (this._remaining--, t === M ? Y(n, r) : this._result[e] = r), 0 === this._remaining && F(n, this._result);
                ...
                var W = function() {
                    function e(t) {
                        this[j] = L++, this._result = this._state = void 0, this._subscribers = [], S !== t && ("function" != typeof t && function() {
                ...
                return W.prototype.then = g, W.all = function(t) {
                ...
                }, W.resolve = A, W.reject = function(t) {
                    var e = new this(S);
                    return Y(e, t), e;
                ...
                return h(t, [
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            var n = this._id++;
                            return this._listeners[n] = t, function() {
                                return delete e._listeners[n];
                            };
                        }
                    }
                ]), t;
            }(), v = "__private__memoized__arguments__", _ = function(t) {
                function n() {
                    var t;
                    p(this, n);
                ...
                return l(n, b), h(n, [
                    {
                        ...
                        value: function() {
                            ...
                            this[v] = r, (t = c(f(n.prototype), "dispatch", this)).call.apply(t, [
                                this
                            ].concat(r));
                        }
                    },
    ...
    "sCMk": [
        function(require, module1, exports) {
            ...
            var o = require("es6-promise"), l = o.Promise, u = require("./signal"), c = u.Signal;
            function d(e, n) {
                e.addEventListener("message", function r(a) {
                    var s = a.data;
                    "connect" === s.method && (e.removeEventListener("message", r), n.apply(void 0, t(s.params)));
                });
            }
            ...
            var f = function() {
                function n(r, t) {
                    var a = this;
                    e(this, n), this._messageHandlers = {}, this._responseHandlers = {}, this._send = h(r, t.parent), t.addEventListener("message", function(e) {
                ...
                return r(n, [
                    {
                        key: "call",
                        value: function(e) {
                            for(var n = this, r = arguments.length, t = new Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++)t[a - 1] = arguments[a];
                            var s = this._send(e, t);
                            return new l(function(e, r) {
                                n._responseHandlers[s] = {
                                    resolve: e,
                                    reject: r
                                };
                            });
                    ...
                    },
                    {
                        key: "addHandler",
                        value: function(e, n) {
                            return e in this._messageHandlers || (this._messageHandlers[e] = new c), this._messageHandlers[e].attach(n);
                        }
                    },
                    {
                        key: "_handleMessage",
                        value: function(e) {
                            if (e.method) {
                                var n = e.method, r = e.params, a = this._messageHandlers[n];
                                a && a.dispatch.apply(a, t(r));
                            } else {
                                var s = e.id, i = this._responseHandlers[s];
                                if (!i) return;
                                "result" in e ? i.resolve(e.result) : "error" in e && i.reject(e.error), delete this._responseHandlers[s];
                            }
                        }
                    }
                ]), n;
    ...
    "Mq5l": [
        function(require, module1, exports) {
            var e = require("es6-promise"), n = e.Promise, r = require("./channel");
            function t() {
                var e = {};
                return e.promise = new n(function(n) {
                    e.resolve = n;
                }), e;
            }
            module1.exports = function(e, n) {
    ...
    "GnXy": [
        function(require, module1, exports) {
            ...
            var i = require("./signal"), l = i.MemoizedSignal;
            module1.exports = function() {
                function a(n, i) {
                    var t = this;
                    e(this, a), this.id = i.id, this.locale = i.locale, this.type = i.type, this.validations = i.validations, this._value = i.value, this._valueSignal = new l(this._value), this._isDisabledSignal = new l(void 0), this._schemaErrorsChangedSignal = new l(void 0), this._channel = n, n.addHandler("valueChanged", function(e, a, n) {
                        e !== t.id || a && a !== t.locale || (t._value = n, t._valueSignal.dispatch(n));
                    }), n.addHandler("isDisabledChanged", function(e) {
                        t._isDisabledSignal.dispatch(e);
                    }), n.addHandler("schemaErrorsChanged", function(e) {
                        t._schemaErrorsChangedSignal.dispatch(e);
                    });
                }
                return n(a, [
                    {
                    ...
                    },
                    {
                        key: "setValue",
                        value: function(e) {
                            return this._value = e, this._valueSignal.dispatch(e), this._channel.call("setValue", this.id, this.locale, e);
                        }
                    },
                    {
                        key: "removeValue",
                        value: function() {
                            return this._value = void 0, this._channel.call("removeValue", this.id, this.locale);
                        }
                    },
                    {
                        key: "setInvalid",
    ...
    "daBI": [
        function(require, module1, exports) {
            ...
            var a = require("./field-locale");
            function i(e, t) {
                if (!e._fieldLocales[t]) throw new Error('Unknown locale "'.concat(t, '" for field "').concat(e.id, '"'));
            }
            module1.exports = function() {
                function t(l, n, o) {
                    var u = this;
                    e(this, t), this.id = n.id, this.locales = n.locales, this.type = n.type, this.validations = n.validations, this._defaultLocale = o, this._fieldLocales = {}, this.locales.forEach(function(e) {
                        var t = n.values[e];
                        u._fieldLocales[e] = new a(l, {
                            id: u.id,
                            locale: e,
                            value: t
                        });
                ...
                return l(t, [
                    ...
                    },
                    {
                        key: "onIsDisabledChanged",
                        value: function(e, t) {
                            return t || (t = e, e = void 0), this._getFieldLocale(e).onIsDisabledChanged(t);
                        }
                    },
                    {
                        key: "_getFieldLocale",
                        value: function(e) {
                            return i(this, e = e || this._defaultLocale), this._fieldLocales[e];
                        }
                    }
                ]), t;
            }();
    ...
    "XV20": [
        function(require, module1, exports) {
            module1.exports = function(e, t) {
                var n = e.document, i = e.MutationObserver, r = function() {
                    c.updateHeight();
                }, u = new i(r), o = null, s = !1, c = {
                    startAutoResizer: function() {
                        if (c.updateHeight(), s) return;
                        s = !0, u.observe(n.body, {
                            attributes: !0,
                            childList: !0,
                            subtree: !0,
                            characterData: !0
    ...
    "97BZ": [
        function(require, module1, exports) {
            var n = require("./signal"), e = n.MemoizedSignal;
            module1.exports = function(n, r, t, i) {
                var u = r.sys, a = new e(u);
                return n.addHandler("sysChanged", function(n) {
                    u = n, a.dispatch(u);
                }), {
                    getSys: function() {
                        return u;
    ...
    "6GEt": [
        function(require, module1, exports) {
            ...
            module1.exports = function(t) {
                ...
                function l(n, e, l) {
                    return (l = o(l)).entityType = n, l.multiple = e, t.call("openDialog", "entitySelector", l);
                }
                function o(t) {
            ...
            module1.exports = function(n) {
                return {
                    openEntry: function(e, r) {
                        return n.call("navigateToContentEntity", t({}, r, {
                            entityType: "Entry",
                            id: e
                        }));
                    },
                    ...
                    openNewAsset: function(e) {
                        return n.call("navigateToContentEntity", t({}, e, {
                            entityType: "Asset",
                            id: null
                        }));
                    }
    ...
    "LVu9": [
        function(require, module1, exports) {
            ...
            var t = require("./field"), o = require("./field-locale"), u = require("./window"), i = require("./entry"), a = require("./space"), c = require("./dialogs"), l = require("./navigator"), s = require("./locations"), f = [
                d,
                y,
                _
            ], O = (n(e = {}, s.LOCATION_ENTRY_FIELD, f), n(e, s.LOCATION_ENTRY_FIELD_SIDEBAR, f), n(e, s.LOCATION_ENTRY_SIDEBAR, [
                d,
                y
            ]), n(e, s.LOCATION_DIALOG, [
                d,
                p
            ]), e);
            function d(e, r, n) {
                var t = r.user, o = r.parameters, i = r.locales;
                return {
                    location: {
                        is: function(e) {
                    ...
                    request: function(r) {
                        return e.call("___internal___request", r);
                    }
                };
            }
            function y(e, r) {
                var n = r.locales, o = r.contentType, u = r.entry, a = r.fieldInfo;
                return {
                    contentType: o,
                    entry: i(e, u, a, function(r) {
            ...
            module1.exports = function(e, n, t) {
                return (O[n.location] || f).reduce(function(o, u) {
                    return r({}, o, u(e, n, t));
                }, {});
            };
        },
    ...
    "Focm": [
        function(require, module1, exports) {
            var i = require("./initialize"), e = require("./api"), r = require("./locations");
            module1.exports = {
                init: i(window, e),
                locations: r
            };
    ...
    "Focm"
], "contentfulExtension") //# sourceMappingURL=/cf-extension-api.map
;

},{}],"8Fle5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "recursiveClone", ()=>recursiveClone);
...
async function publishEntry(space, entry) {
    await wait(waitTime);
    return await space.publishEntry(space, entry);
}
...
async function inspectField(space, field) {
    if (field && Array.isArray(field)) return await Promise.all(field.map(async (f)=>{
        return await inspectField(space, f);
    }));
    if (field && field.sys && field.sys.type === "Link" && field.sys.linkType === "Entry") await findReferences(space, field.sys.id);
}
async function findReferences(space, entryId) {
    if (references[entryId]) return;
...
async function recursiveClone(space, entryId, tag) {
    ...
    statusUpdateTimer = setInterval(()=>{
        (0, _log.log)(` - found ${referenceCount} entries so far...`);
    }, statusUpdateTimeout);
    await findReferences(space, entryId);
    clearInterval(statusUpdateTimer);
    (0, _log.log)(` -- Found ${referenceCount} reference(s) in total`);
    (0, _log.log)("");
...
},{"./log":"9ULp7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ULp7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function log(str) {
    ...
    if (console) console.log("DeepCopy: " + str);
}
...
},{}]},["7vIXm","1xC6H","due8H"], "due8H", "parcelRequire3810")

//# sourceMappingURL=index.81e41450.js.map
